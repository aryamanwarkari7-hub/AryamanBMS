    ...
    public class GstDashboardService : IGstDashboardService
    {
            ...
            int year)
        {
            ...
            return new GstDashboardViewModel
            {
                ...
                FiledByUserId = snapshot.FiledByUserId,
                FiledOn = snapshot.FiledOn,
                ReopenedByUserId = snapshot.ReopenedByUserId,
                ReopenedOn = snapshot.ReopenedOn,
                ReopenReason = snapshot.ReopenReason,
                ...
                PreviousITCCarryForward = snapshot.PreviousITCCarryForward,
                OutputCGSTBalance = snapshot.OutputCGSTBalance,
                OutputSGSTBalance = snapshot.OutputSGSTBalance,
                OutputIGSTBalance = snapshot.OutputIGSTBalance,
                InputCGSTBalance = snapshot.InputCGSTBalance,
                InputSGSTBalance = snapshot.InputSGSTBalance,
                InputIGSTBalance = snapshot.InputIGSTBalance,
                ITCUtilizedForIGST = snapshot.ITCUtilizedForIGST,
                ITCUtilizedForCGST = snapshot.ITCUtilizedForCGST,
                ITCUtilizedForSGST = snapshot.ITCUtilizedForSGST,
                CashPayableIGST = snapshot.CashPayableIGST,
                CashPayableCGST = snapshot.CashPayableCGST,
                CashPayableSGST = snapshot.CashPayableSGST,
